...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.upgradefirmware.tk (自动编译最新版本后端-测试）": "https://sub.upgradefirmware.tk/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://sub.upgradefirmware.tk/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://sub.upgradefirmware.tk/sub?";
